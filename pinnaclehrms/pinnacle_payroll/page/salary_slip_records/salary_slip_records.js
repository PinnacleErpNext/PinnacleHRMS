	...
	$form.find("#fetch_records").click(function () {
        ...
        <tr>
          ...
          <tr>
            ...
            <td>${info["Full Day"]?.days || 0}</td>
            <td>${info["Sunday Workings"]?.days || 0}</td>
            <td>${info["Half Day"]?.days || 0}</td>
            <td>${info["3/4 Quarter Day"]?.days || 0}</td>
            <td>${info["Quarter Day"]?.days || 0}</td>
            <td>${info["Lates"]?.days || 0}</td>
            <td>${rec.absent || 0}</td>
            <td>${rec.total || 0}</td>
            ${otherCells}
